...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-24">
      <header className="flex flex-col justify-center items-center w-full h-52 bg-gray-700 relative">
        <img
          src={Logo}
        ...
        <div className="inputArea flex gap-2 h-14 w-full md:max-w-[50%] max-md:max-w-[90%]  absolute bottom-0 translate-y-[50%]">
          <div className="input w-full bg-gray-500 border border-gray-700 rounded-lg">
            <input
              type="text"
              className="w-full h-full text-gray-300 placeholder:text-gray-300 placeholder:text-16 bg-transparent text-16 pl-4 outline-none "
